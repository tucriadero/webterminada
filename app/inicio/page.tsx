...
<section className="mt-16 px-4 max-w-7xl mx-auto space-y-20">
  ...
  <div className="flex gap-4 px-4 py-2 w-max mx-auto">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="bg-white rounded-2xl shadow p-4 aspect-square w-52 flex flex-col justify-center items-center hover:shadow-xl hover:-translate-y-1 transition duration-300"
        >
  ...
  <div className="flex gap-4 px-4 py-2 w-max mx-auto">
      {[1, 2, 3, 4].map((i) => (
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-800 text-center">Criador {i}</h3>
          <p className="text-sm text-gray-600 text-center">Especializado en raza X</p>
        </div>
      ))}
    </div>
  </div>
  ...
  <div className="flex gap-4 px-4 py-2 w-max mx-auto">
      {[1, 2, 3, 4].map((i) => (
        <div
          ...
          className="bg-white rounded-2xl shadow p-4 aspect-square w-52 flex flex-col justify-center items-center hover:shadow-xl hover:-translate-y-1 transition duration-300"
        >
          <h3 className="text-lg font-semibold text-gray-800 text-center mb-2">Título del blog {i}</h3>
